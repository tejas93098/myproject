# wasmpolyfills/node-sqlite3

This is a _fork_ of [node-sqlite3](https://github.com/mapbox/node-sqlite3) using WebAssembly instead of a native addon.

This package is _experimental_ and a work in progress! There's plenty of stuff that might not work and that does not work. Take a look at the open [issues](https://github.com/wasmpolyfills/node-sqlite3/issues).
